      ...
      <div className="md:w-1/3 flex flex-col items-center justify-between gap-3">
        ...
        <div className="w-full flex gap-2">
          <button
            ...
            disabled={isLoading}
            className="flex-1 min-w-0 truncate flex items-center justify-center px-4 py-2 bg-brand-secondary text-white font-semibold rounded-md hover:bg-blue-600 disabled:bg-slate-600 disabled:cursor-not-allowed transition-colors"
          >
